...
public class Exercicio11 {
	...
	System.out.println(" O seu salario antes do ajuste era de R$ : " +salario);
	System.out.println(" O percentual de ajuste foi de : " +percentual+  " % ");
	System.out.println( "O valor de aumento foi de R$ : "+aumento);
	System.out.println(" O seu salario após o aumento é de R$ : "+salarioAjustado);
